...
// UploadFiles uploads one or more file to a specified directory, and gives the files a random
// It returns a slice containing the newly named files, the original file names, the size of the
...
// PushJSONToRemote posts arbitrary data to some URL as JSON, data returns the response, statusCode, and error, if any.
